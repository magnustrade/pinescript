...
// by © therkut
//@version=6
indicator("therkut(8)", overlay= true, max_bars_back = 500)
//-----------------------------------------------------------------------------{}
...
//-----------------------------------------------------------------------------{    
//3- Diagonal Supports and Resistances
//-----------------------------------------------------------------------------
diagonalSprs_ok = input(true, title = '═══════════════ Diagonal Supports and Resistances Settings ')
...
//-----------------------------------------------------------------------------{    
//4- ZigZag with Fibonacci Levels
//-----------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------{           
//7- Don Chain Channels
////////////////////////
don_ok = input(false, title = '═══════════════ DonChain Channels Settings')
don_length = input.int(20, minval = 1)
lower = ta.lowest(don_length)
upper = ta.highest(don_length)
basis = math.avg(upper, lower)
plot(don_ok ? basis : na, 'Basis', color = color.new(#FF6D00, 0))
u = plot(don_ok ? upper : na, 'Upper', color = color.new(#2962FF, 0))
l = plot(don_ok ? lower : na, 'Lower', color = color.new(#2962FF, 0))
